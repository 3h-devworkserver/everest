                          ...
                          <div class="form-group required">
                            ...
                            <div class="form-group required">
                              ...
                              <div class="form-group required">
                                ...
                                <div class="form-group required">
                                {!! Form::label('password', trans('validation.attributes.password'), ['class' => 'col-lg-2 col-md-2 control-label']) !!}
                                <div class="col-lg-10">
                                ...
                                <div class="form-group required">
                                {!! Form::label('password_confirmation', trans('validation.attributes.password_confirmation'), ['class' => 'col-lg-2 col-md-2 control-label']) !!}
                                <div class="col-lg-10">
                                        ...
                                        <!-- <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                              ...
                                              {!! Form::submit(trans('strings.save_button'), ['class' => 'btn btn-success']) !!}
                                              </div>
                                            </div>
                                          </div>
