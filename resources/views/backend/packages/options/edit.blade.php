...
@section ('title', trans('Edit Package Option'))

@section('page-header')
<h1>
	{{ trans('Package Option Management') }}
	<small>{{ trans('menus.packages.options.edit') }}</small>
</h1>
@endsection
...
<li class="active">{!! trans('Packages Option Edit') !!}</li>
@stop

@section('content')
{!! Form::model($option, ['url'=>'admin/packages/options/'.$option->id, 'id'=>'package-form', 'method'=>'patch']) !!}
