...
@section ('title', trans('Edit Registration Email'))

@section('page-header')
<h1>
	{{ trans('Traveller Registration Email Management') }}
	<small>{{ trans('menus.email.travellerregister.edit') }}</small>
</h1>
@endsection
...
<li class="active">{!! trans('Traveller Registration Email Edit') !!}</li>
@stop
