...
@include('frontend.includes.new.functions')
 ...
 <section class="main-content">
        ...
        <section id="vertical">
            ...
            <p><button id="init-vertical" type="button" class="btn btn-large btn-primary">Start Example</button></p>
                                ...
                                <div class="form-group">
                                    <div class="row-fluid">
                                        ...
                                        <label for="">Passport Number</label>
                                           <input type="text" name="adult_passport[]" class="form-control" placeholder="Passport Number" required>
                                        </div>
                                        <div class="col-md-4">
                                        <label for="">Issuing Country</label>
                                            {!! Form::select('adult_issue_country[]',$countries, 'NP', ['class'=>'SlectBox country form-control', 'required']) !!}
                                            <!--
                                    ...
                                    <div class="form-group">
                                        <div class="row-fluid">
                                            <div class="col-md-5">
                                               ...
                                               {!! Form::select('main_traveller_country',$countries, 'NP', ['class'=>'SlectBox country form-control', 'required']) !!}
                                            </div>
                                            <div class="col-md-3">
