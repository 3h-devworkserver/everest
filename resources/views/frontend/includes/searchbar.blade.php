<div class="search-cat">
	<form id="guide-search" action="{{URL::to('search/results')}}" method="get" >
		...
		<div class="input-type">
			<input id="datefilter" type="text" name="available" value="" placeholder="Availability"/>
		...
		<div class="input-type">
			<input type="text" name="dest-name" id="autocomplete-name" placeholder="Name, Destination, Skill" value="@if(!empty($selectedname)){{$selectedname}}@endif">
		</div>
