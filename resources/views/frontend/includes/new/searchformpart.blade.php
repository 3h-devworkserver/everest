								...
								<div class="row">
									<div class="col-md-6 col-sm-6">
										...
										<select name="departure" placeholder="Your place of departure" class="form-control locations">
											...
											<option value="{{$sect->SectorCode}}" selected="selected">{{$sect->SectorName}}
												@else
								                    	...
								                    	<div class="row">
								                    		<div class="col-md-12">
													    		...
													    		<!--	<label>Infant:0-2 yrs</label
															      ...
															      @if(empty($country))
															      {!! Form::select('country', $countries, 'NP', ['class' => 'form-control country']) !!}
															      @else
															      {!! Form::select('country', $countries, $country, ['class' => 'form-control country']) !!}
															      @endif
